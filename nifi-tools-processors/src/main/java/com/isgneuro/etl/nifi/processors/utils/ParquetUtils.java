...
import com.isgneuro.etl.nifi.processors.PutParquetNoAvro;
...
public class ParquetUtils {
    ...
    public static ParquetConfig createParquetConfig(final PropertyContext context, final Map<String, String> variables) {
        ...
        if(context.getProperty(PutParquetNoAvro.OVERWRITE).isSet()) {
            overwrite = context.getProperty(PutParquetNoAvro.OVERWRITE).asBoolean();
        }
